...
'PEPPERCARROT_VEGETABLE'    =>  'Pepper ha Carrot', // litteral translation of spices + vegetable
'Website_DESCRIPTION'        =>  'Pajenn degemer kefridiel Pepper&amp;Carrot, ur webcomic digoust, frank ha mammenn digor diwar-benn Pepper, ur sorserez yaouank hag he c\'hazh, Carrot. Beva&ntilde; a reont en ur bed faltaziek leun a vraouedo&ugrave;, a hudouriezh hag a grouadurio&ugrave;.',
'SUBTITLE'                  =>  'ar Webcomic digor gant David Revoy',
...
'ADD_TRANSLATION'       => 'ouzhpenna&ntilde; un droidigezh',
'CORRECTIONS' 			=> 'kinnig ur reizhadenn',
...
'CONTRIBUTE_BOTTOM'	    => '
    ...
    <p> An holl a c\'hall kemer perzh e doareo&ugrave; dishe&ntilde;vel :<br/>
        <b>Diorroerien :</b> Kroui&ntilde; un arload evit lenn Pepper&amp;Carrot war trevnado&ugrave; hezoug.<br />
        <b>Sonerien :</b>  aoza&ntilde; sonerezh evit Pepper&amp;Carrot.<br />
        <b>Skrivagnerien : </b>  kinnig istorio&ugrave; Pepper&amp;Carrot nevez.<br />
...
################################################################################
# Page: Sources
'SOURCES_TITLE'		    => 'Mammenno&ugrave;',
'SOURCES_TOP'	        => '
    <p><b>Degemer mat war greizenn pellgarga&ntilde; ar mammenno&ugrave; !</b><br/>
    Kavet e vo aze restro&ugrave; mammenn Pepper&amp;Carrot ha muioc\'h c\'hoazh.<br/>
    An holl restro&ugrave; livadur niverel kavet ama&ntilde; a zo kenglotus gant handelv diwezha&ntilde; <a href="https://krita.org/">Krita</a>.</p>
',
'SOURCES_BOTTOM'	    => '
...
'SOURCE_TRANSLATOR'=>  'Pakad an troer',
'SOURCE_WEB'      =>  'Web <span class="sourceinfos"> 90ppi, jpg ska&ntilde;v </span>',
'SOURCE_PRINT'        =>  'Moulla&ntilde; <span class="sourceinfos"> 300ppi, perzhded hep koll </span>',
'SOURCE_MONTAGE'   =>  'Framma&ntilde; <span class="sourceinfos"> An holl banello&ugrave; en ur bajenn </span>',

################################################################################
# Page: Author
'AUTHOR_TITLE'		=> 'A-zivout David Revoy',
'AUTHOR_BIO'	    => '
    <p>Demat, David Revoy eo va anv. Un arzour gall ganet e 1981 on me. Desket em eus va-unan ha sot on gant an tresa&ntilde;, al livouriezh, ar c\'hizhier, an urzhiataerio&ugrave;, ar sevenadur mammenn digor GNU/Linux, ar genrouedad, ar c\'hoario&ugrave;-video RPG mod kozh, ar manga hag anime kozh, an arz hengounel, ar sevenadur japanat, ar moliac\'h&nbsp;.&nbsp;.&nbsp;.&nbsp;<br />
    <br />
    Goude beza&ntilde; bet 10 vloaz o labourat ma-unan el livouriezh niverel, en deskadurezh, en arz-meizad, er skeudenni&ntilde;, er renerezh-arzel, em eus divizet kregi&ntilde; gant va raktres din-me. Kavet em eus un doare da veska&ntilde; kement a laka birvilh ennon asambles; hag an disoc\'h a zo Pepper&amp;Carrot.</p>
...
'FOOTER_CONTENT'    => '
    ...
    Da lakaat war anv "David Revoy, www.davidrevoy.com". Deuit e darempred ganin : <a href="mailto:info@davidrevoy.com">info@davidrevoy.com</a> evit gouzout hiroc\'h.</p>
...
################################################################################
# various utils:
'UTIL_NEXT_EPISODE'      =>  'rann war-lerc\'h',
'UTIL_PREVIOUS_EPISODE'  =>  'rann gent',
'UTIL_EPISODE'   =>  'rann',
'UTIL_BACK_TO_GALLERY'      =>  'distrei&ntilde; d\'ar skeudenaoueg',
'UTIL_MORE'      =>  'muioc\'h',
'UTIL_PAGE'      =>  'pajenn',
'UTIL_BY'        =>  'gant',
