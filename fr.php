...
# Global
'TRANSLATED_BY' 		=> 'Traduction : <a href="https://www.davidrevoy.com">David Revoy</a>',
'LANGUAGE_NAME' 			=> 'Français',
'LANGUAGE_ISO_CODE_2_LETTER'=> 'fr',
...
'CORRECTIONS' 			=> 'proposer une correction',
...
'CONTRIBUTE_FANART'	    => '
    ...
    <br/> (<a href="mailto:info@davidrevoy.com">info@davidrevoy.com</a> , ou notifiez-en moi sur un réseau social).</p>
',
'CONTRIBUTE_DERIVATIONS' => '
    <h2>Adaptations</h2>
    <p>Pepper&amp;Carrot peut-être décliné en beaucoup de produits ou de projets (même commerciaux), et pourquoi pas le vôtre ?<br/>
...
'SOURCES_TOP'	=> '
    <p><b>Bienvenue au centre de téléchargement des fichiers sources !</b><br/>
    Vous trouverez ici tous les fichiers sources de Pepper&amp;Carrot.<br/>
    Les fichiers de peinture numérique sont compatibles avec la dernière version de <a href="https://krita.org/">Krita</a></p>
',
'SOURCES_BOTTOM'	=> '
...
'SOURCE_TRANSLATOR'=>  'Pack à l\'usage des traducteurs',
'SOURCE_WEB'      =>  'Internet <span class="sourceinfos"> 90ppi, fichier jpg léger</span>',
'SOURCE_PRINT'        =>  'Impression <span class="sourceinfos"> 300ppi, sans perte de qualité </span>',
'SOURCE_MONTAGE'   =>  'Collage <span class="sourceinfos"> Toutes les cases dans une seule image </span>',

################################################################################
# Page : Author
'AUTHOR_TITLE'		    => 'À propos de David Revoy',
'AUTHOR_BIO'	        => '
...
',
'AUTHOR_TODO_DREAM'	    => '
    <h3>Mes rêves pour ce projet :</h3>
...
################################################################################
# various utils :
'UTIL_NEXT_EPISODE'     =>  'épisode suivant',
'UTIL_PREVIOUS_EPISODE' =>  'épisode précédent',
'UTIL_EPISODE'   =>  'épisode',
'UTIL_BACK_TO_GALLERY'      =>  'retour à la galerie',
'UTIL_MORE'      =>  'plus',
'UTIL_PAGE'      =>  'page',
'UTIL_BY'        =>  'par',
