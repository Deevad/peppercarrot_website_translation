...
# Global
'TRANSLATED_BY' 		    => 'przekłŏd: Grzegorz Kulik',
'LANGUAGE_NAME' 			=> 'Ślōnskŏ gŏdka',
'LANGUAGE_ISO_CODE_2_LETTER'=> 'sz',
...
################################################################################
# Top menu website:
'HOMEPAGE'      =>  'Przodniŏ strōna',
'WEBCOMICS'     =>  'Kōmiks',
'BLOG'          =>  'Blog',
'PHILOSOPHY'    =>  'Filozofijŏ',
'CONTRIBUTE'    =>  'Spōmōż nŏs',
'SOURCES'       =>  'Źrōdła',
'AUTHOR'        =>  'Autōr',
...
'CORRECTIONS' 			=> 'doradź poprŏwki',

################################################################################
# Page: Homepage
'HOMEPAGE_BIG_TEXT'		    =>  '
    Darmy i ôdewrzōny internetowy kōmiks<br/>
    spiyrany bezpostrzednio bez czytŏczōw,<br/>
    coby zmiynić branżã kōmiksōw!<br/>
',
'HOMEPAGE_PATREON_INFO'     =>  'Wystyknie 1$ na Patreōnie, coby być patrōnym nowyj tajle',
'HOMEPAGE_MOREINFO_BUTTON'  =>  'Wiyncyj informacyji',
'HOMEPAGE_PATREON_BUTTON'   =>  'Wesprzij nowõ tajlã Pepper&amp;Carrot na Patreōnie',
'HOMEPAGE_PATREON_BOX'      =>  'Wesprzij nowõ tajlã Pepper&amp;Carrot na:',
...
'CONTRIBUTE_BOTTOM'	    => '
    ...
    <p>Kożdy może pōmŏgać jak chce:<br/>
        <b>Dewelopery:</b>  zrychtowanie czytnika na mobilne masziny.<br />
        <b>Muzyki:</b>  kōmpōnowanie tymatōw dlŏ Pepper&amp;Carrot.<br />
        <b>Pisŏrze:</b>  forszlagi nowych scynariuszōw.<br />
...
'SOURCE_TRANSLATOR'=>  'Kōmplet przekłŏdŏcza',
'SOURCE_WEB'      =>  '<span class="sourceinfos">Leke zbiory JPG dlŏ strōn (90ppi)</span>',
'SOURCE_PRINT'        =>  '<span class="sourceinfos">Bezstratne zbiory do druku (300ppi)</span>',
'SOURCE_MONTAGE'   =>  '<span class="sourceinfos">Wszyjske panele na jednyj strōnie</span>',

################################################################################
# Page: Author
'AUTHOR_TITLE'		=> 'Ô Davidzie Revoyu',
'AUTHOR_BIO'	    => '
    <p>Serwus, mianujã sie David Revoy i je żech francuskim kōnsztlerym narodzōnym we 1981 roku. Je żech samoukym, co pasjōnuje sie cechōnkym, malyrkōm, kotami, kōmputrami, kulturōm ôdewrzōnych źrōdeł GNU/Linuksa, Internetym, starymi szpilami RPG, mangami i anime, kōnsztym tradycyjnym, japōńskōm kulturōm i fantastykōm&nbsp;.&nbsp;.&nbsp;.&nbsp;<br />
    <br />
    Po pōnad dziesiyńciu latach digitalnyj malyrki, wynauczaniŏ, tworzyniŏ cechōnkōw kōncepcyjnych i ilustracyji i kerowaniŏ robotami uzdołch napoczōńć włŏsny projekt. W kōńcu znŏdłech knif zmiynszaniŏ wszyjskich mojich spodobań; rezultatym je Pepper&amp;Carrot.</p>
...
'AUTHOR_TODO_DREAM'	=> '
    ...
    <p>
    ☐ Pedzieć ô Pepper&amp;Carrot na japōńskim kōnwyncie kōmiksowym<br/>
...
'AUTHOR_CARREER_TITLE'				 => 'moja kariera w 7 bōmbelkach:',
...
'FOOTER_CONTENT'    => '
    <p>Kōmiks, ôbrŏzki i teksty sōm na licyncyji <a href="https://creativecommons.org/licenses/by/4.0/" title="Coby przewiedzieć sie wiyncyj, przeczytej Creative Commons Uzdanie autorstwa 4.0">Creative Commons Uzdanie autorstwa 4.0</a>, jeźli strōna niy gŏdŏ inakszyj.<br/>
    Uzdanie autostwa "David Revoy, www.davidrevoy.com". Napisz dō mie: <a href="mailto:info@davidrevoy.com">info@davidrevoy.com</a>, coby przewiedzieć sie wiyncyj.</p>
...
################################################################################
# various utils:
'UTIL_NEXT_EPISODE'      =>  'dalszŏ tajla',
'UTIL_PREVIOUS_EPISODE'  =>  'piyrwyjszŏ tajla',
'UTIL_EPISODE'   =>  'tajla',
'UTIL_BACK_TO_GALLERY'      =>  'nazŏd do galeryje',
'UTIL_MORE'      =>  'wiyncyj',
'UTIL_PAGE'      =>  'strōna',
'UTIL_BY'        =>  'bez',
'UTIL_DOT'   =>  '.',
