...
'ADD_TRANSLATION'       => 'Thêm bản dịch khác',
'CORRECTIONS' 			=> 'chỉnh sửa',

################################################################################
# Page: Homepage
'HOMEPAGE_BIG_TEXT'		    =>  '
    Một nguồn truyện trực tuyến hoàn toàn miễn phí<br/>
    ủng hộ trực tiếp bởi người đọc<br/>
    để thay đổi nền công nghệ truyện tranh<br/>
',
...
'LIMITATIONS' 		=> 'Trang này chỉ hiển thị tiếng Anh.',
...
'SOURCES_TITLE'		    => 'Nguồn',
'SOURCES_TOP'	        => '
    <p><b>Chào mừng đến trung tâm nguồn!</b><br/>
    Bạn sẽ tìm thấy các file nguồn của Hạt Tiêu&amp;Cà Rốt và nhiều hơn nữa.<br/>
    Tất cả các file hình ảnh chất lượng cao đây là tương thích với các phiên bản mới nhất của <a href="https://krita.org/">Krita</a>.</p>
',
'SOURCES_BOTTOM'	    => '
...
'FOOTER_CONTENT'    => '
    <p>Truyện tranh, các tác phẩm và văn bản được ký giấy phép bởi CC-By license, trừ khi có ghi chú khác trong trang.<br/>
...
'UTIL_PREVIOUS_EPISODE'  =>  'Tập trước',
'UTIL_EPISODE'   =>  'Tập',
'UTIL_BACK_TO_GALLERY'      =>  'Trở lại gallery',
'UTIL_MORE'      =>  'nhiều hơn',
'UTIL_PAGE'      =>  'trang',
'UTIL_BY'        =>  'bởi',
